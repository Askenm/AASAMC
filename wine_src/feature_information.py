...
pd.DataFrame({'distribution':list(weighted_sum.keys()),
              'average_feature_information_rank':list(weighted_sum.values())}).to_csv('results/feature_information.csv',index=None)