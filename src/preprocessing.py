...
NOTE FROM VIKTOR: I CREATED A SEPERATE SCRIPT FOR EMBEDDING CREATION. IT CAN BE FOUND IN THE SRC FOLDER.
...
def vectorize_corpus(
    corpus, labels, save_path="../data/processed/onehot_representation.pkl"
):
    ...
    vector = np.c_[vector.T, np.asarray(labels)]
